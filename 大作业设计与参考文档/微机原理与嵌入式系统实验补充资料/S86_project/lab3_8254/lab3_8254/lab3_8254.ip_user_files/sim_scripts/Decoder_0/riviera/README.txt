...
#
# Generated by export_simulation on Wed Aug 07 11:18:55 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './Decoder_0.sh' script.

./Decoder_0.sh -reset_run
...
./Decoder_0.sh -noclean_files

For more information on the script, please type './Decoder_0.sh -help'.
