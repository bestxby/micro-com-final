...
overview_html = head_html + """
  <div style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: flex-start; overflow: hidden; padding-top: 0px;">
...
# We don't need the complex remote CSS anymore, just the base file
