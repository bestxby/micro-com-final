...
#
# Script generated by Vivado on Sat Jun 13 16:49:08 +0800 2026
...
export RDI_DATADIR="D:/Vivado_zync_2025/2025.2/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Vivado_zync_2025/2025.2/Vivado/data/xsim"
  fi
